...
> Lineage: 0 outbound / 3 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 1 · Changelog: fresh (2 d)
...
| Pkg folder | [packages\peer-nodes](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\peer-nodes) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package peer-nodes -Apply
