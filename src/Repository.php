...
namespace BlackCat\Database\Packages\PeerNodes;
...
use BlackCat\Database\Packages\PeerNodes\Repository\PeerNodeRepository as GeneratedRepository;
...
{
  private PeerNodeRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof PeerNodeRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected PeerNodeRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\PeerNodes\Dto\PeerNodeDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\PeerNodes\Dto\PeerNodeDto|null { return $this->repo->getById($id, $asDto); }
