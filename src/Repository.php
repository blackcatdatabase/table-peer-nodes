...
use BlackCat\Database\Packages\PeerNodes\Repository\PeerNodeRepository;
...
{
    private PeerNodeRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new PeerNodeRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\PeerNodes\Dto\PeerNodeDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\PeerNodes\Dto\PeerNodeDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\PeerNodes\Dto\PeerNodeDto|null
    {
