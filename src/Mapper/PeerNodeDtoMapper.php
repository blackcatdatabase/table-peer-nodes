...
namespace BlackCat\Database\Packages\PeerNodes\Mapper;

use BlackCat\Database\Packages\PeerNodes\Dto\PeerNodeDto;
use BlackCat\Database\Packages\PeerNodes\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO PeerNodeDto:
 ...
 */
final class PeerNodeDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'name' => 'name', 'type' => 'type', 'location' => 'location', 'status' => 'status', 'last_seen' => 'lastSeen', 'meta' => 'meta', 'created_at' => 'createdAt' ];
    ...
    /** @var string[] */
    private const DATE_COLS   = [ 'last_seen', 'created_at' ];
    /** @var string[] */
     ...
     * @return PeerNodeDto
     */
    public static function fromRow(array $row): PeerNodeDto
    {
        /** @var PeerNodeDto */
    ...
    public static function fromRowOrNull(?array $row): ?PeerNodeDto
    {
     ...
     *
     * @param PeerNodeDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(PeerNodeDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(PeerNodeDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(PeerNodeDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,PeerNodeDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,PeerNodeDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(PeerNodeDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,PeerNodeDto>
     */
