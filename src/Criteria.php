...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'name', 'type', 'location', 'status', 'last_seen', 'meta', 'created_at' ];
    }
    ...
    {
        return [ 'id', 'name', 'type', 'location', 'status', 'last_seen', 'created_at' ];
    }
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\PeerNodes\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\PeerNodes\Definitions::softDeleteColumn();
