...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'peer_nodes'; }
    public static function contractView(): string { return 'vw_peer_nodes'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'name', 'type', 'location', 'status', 'last_seen', 'meta', 'created_at' ]; }
