...
final class PeerNodesModule implements ModuleInterface
{
    public function name(): string { return 'table-peer_nodes'; }
    public function table(): string { return 'peer_nodes'; }
    ...
    public static function contractView(): string { return 'vw_peer_nodes'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_peer_nodes_last_seen', 'idx_peer_nodes_status' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_peer_nodes_last_seen', 'idx_peer_nodes_status' ],
            'foreignKeys' => [],
        ];
    }
}
